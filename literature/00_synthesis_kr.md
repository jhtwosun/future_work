...
| 2 | **M3ID** (Favero et al. [2403.14003](https://arxiv.org/abs/2403.14003)) | CVPR 2024 | $\log p(y \mid I,q)-\log p(y \mid q)$ 를 sampling objective 로 — 정확히 같은 양 | M3ID 는 α-guarantee 없음. CG-VL 의 null 은 `I_shuffle` (unconditioned LM 아님), spatial-semantic grounding 만 분리. Sampling 아니라 abstention |
