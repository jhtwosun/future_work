"""
Rerun E6v2 (Qwen3-8B no-think MATH-500) with MAX_TOKENS=3072 (was 1536).
Original 65/500 (13%) truncated.
"""
...
MAX_TOKENS = int(os.environ.get("MAXTOK", "3072"))
TEMP_SC = 0.7
SEED = 0

OUTDIR = Path("/home/nvidia/future/experiments/results")
GREEDY_OUT = OUTDIR / "E6v3_qwen3_8b_nothink_greedy.jsonl"
SC_OUT = OUTDIR / "E6v3_qwen3_8b_nothink_sc.jsonl"
SUM = OUTDIR / "E6v3_summary.json"
...
def main():
    ...
    summary["greedy"] = {"accuracy": n_correct / len(prompts), "n_truncated": n_truncated,
                          "wallclock_sec": dur_g}
