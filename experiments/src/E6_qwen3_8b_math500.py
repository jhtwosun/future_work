"""
Experiment E6: Qwen3-8B on MATH-500 (greedy + SC@8).
Direct successor to Qwen2.5-7B-Instruct from Pilot 7 / E1.
"""
...
GREEDY_OUT = OUTDIR / "E6_qwen3_8b_greedy.jsonl"
SC_OUT = OUTDIR / "E6_qwen3_8b_sc.jsonl"
SUM = OUTDIR / "E6_summary.json"
